...
# Load models & data
rf_model = joblib.load("../trained_models/rf_model.joblib")
svm_model = joblib.load("../trained_models/svc_model.joblib")
encoder = joblib.load("../trained_models/label_encoder.pkl")

with open("../trained_models/symptom_index.json") as f:
...
def predict_disease(symptoms):
    ...
    final_pred = statistics.mode([rf_pred, svm_pred])
